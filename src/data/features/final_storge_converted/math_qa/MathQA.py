    ...
    def convert(self):
        ...
        for split in self.data_read:
            for data in tqdm(self.data_read[split], desc=f"Converting {split} data"):
                ...
                data_dict['question_text'] = data['Problem']
...
if __name__ == '__main__':
    math_qa_parser = MathQA(r"src/data/features/final_storge_converted/math_qa/dummy.txt",
                            r"src/data/features/final_storge_converted/math_qa")
    math_qa_parser.read()
    math_qa_parser.convert()
    math_qa_parser.save
