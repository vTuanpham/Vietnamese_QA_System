...
PARSER_TYPE = "GradeSchoolMathInstruct"


class GradeSchoolMathInstruct(DataParser):
    ...
    def read(self):
        super(GradeSchoolMathInstruct, self).read()
        self.data_read = load_dataset("qwedsacf/grade-school-math-instructions")

        return None

    def convert(self):
        super(GradeSchoolMathInstruct, self).convert()
...
if __name__ == '__main__':
    grade_school_math_instruct_parser = GradeSchoolMathInstruct(r"src/data/features/final_storge_converted/grade-school-math-instructions/dummy.txt",
                                                                r"src/data/features/final_storge_converted/grade-school-math-instructions")
    grade_school_math_instruct_parser.read()
    grade_school_math_instruct_parser.convert()
    grade_school_math_instruct_parser.save
