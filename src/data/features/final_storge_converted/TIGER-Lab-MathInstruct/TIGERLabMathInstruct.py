...
PARSER_TYPE = "TigerLabMathInstruct"
...
class MathInstruct(DataParser):
    ...
    def convert(self):
        ...
        self.converted_data = data_converted[:60000]

        pass


if __name__ == '__main__':
    math_instruct_parser = MathInstruct(r"src/data/features/final_storge_converted/TIGER-Lab-MathInstruct/dummy.txt",
                                        r"src/data/features/final_storge_converted/TIGER-Lab-MathInstruct")
